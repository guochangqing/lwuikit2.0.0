 ...
 */
public class VSeekBar extends AbsVSeekBar {
    ...
    public interface OnSeekBarChangeListener {
         ...
         */
        void onProgressChanged(VSeekBar seekBar, int progress, boolean fromUser);
         ...
         */
        void onStartTrackingTouch(VSeekBar seekBar);
         ...
         * @param seekBar The SeekBar in which the touch gesture began
         */
        void onStopTrackingTouch(VSeekBar seekBar);
    }
