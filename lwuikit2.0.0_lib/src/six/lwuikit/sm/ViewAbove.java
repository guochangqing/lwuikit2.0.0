...
import six.lwuikit.sm.SlidingMenu.OnClosedListener;
import six.lwuikit.sm.SlidingMenu.OnOpenedListener;
...
public class ViewAbove extends ViewGroup{
	...
	protected void dispatchDraw(Canvas canvas) {
		try {
			canvas.save();
			float scale = (float) ((1.0f-getPercentOpen())*0.13 + 0.87);
			canvas.scale(scale, scale, 0, canvas.getHeight()/2.0f);
